...
def pattern_func():
    pattern = simpledialog.askstring("Fehler bei der Mustereingabe", "Schreiben Sie 'n', um ein neues Muster zu erstellen, \n"
                                                                     "'p', um eines Ihrer vorhandenen Muster zu verwenden.\n"
                                                                     "Drücken Sie 'Abbrechen', um zurückzugehen.")
    while True:
...
root.withdraw()
drawing_color = "black"
all_patterns = [[[1.0, (1.0, 1.0, 1), 90]]]
t.hideturtle()
t.speed(0)
t.Screen().delay(0)
current_polygons = []
all_polygons = []
new_polygons = [[[(0, 0, 1), (100, 0, 1), (100, 100, 1), (0, 100, 1), (0, 0, 1)], True, '#5f4ff2']]
point_x, point_y = 0, 0
